...
type PresentationRepository interface {
	CreatePresentation(ctx context.Context, presentation *domain.PresentationRaw) error
	GetPresentationRawData(ctx context.Context, id string) (*domain.PresentationRaw, error)
	...
	UpdatePresentation(ctx context.Context, presentation *domain.PresentationRaw) error
